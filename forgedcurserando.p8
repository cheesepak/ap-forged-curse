...
function _debug()
	--print(pc.dx,1,120,11)
	--print(#ents,1,120,11)
--[[
	for bi=0,60 do
		local byte=peek(gpio+bi\8)
		local ibit=bi%8
		if bit(byte,ibit) then
			pset(bi+bi\8,124,8)
		end
		byte=peek(gpio+10+bi\8)
		if bit(byte,ibit) then
			pset(bi+bi\8,125,8)
		end
		---[ [
		if not keys[bi+1].got then
			pset(bi+bi\8,126,10)
		end
		if chex[bi+1] then
			if chex[bi+1].item then
				pset(bi+bi\8,127,11)
			end
		end
		--] ]
...
--[[
--glitchy
function glitch(freq)
 if (rnd()*freq<t%freq) reload()
 for i=1,4 do
...
function drawhud()
	...
	local hy=13
	if pc.gotbolts then
		print(">▶:"..pc.bolts,1,hy,6)
		hy+=6
	end
	if pc.iopen then
		print("●:"..pc.g,1,hy,9)
		print("◆:"..pc.food,1,hy+6,11)
		hy+=12
	end
	for sei,se in ipairs(stfx) do
		local t=pc[se.."t"]
...
xin,yin--,itmin
	...
	--[[
	if #keys>0 then
		c.item=makeitem(keys[1])
		deli(keys,1)
	end
	--]]
	--if (itmin)	c.item=makeitem(itmin)
	c.up=chestup
	return add(chsts,c)
end--makechest()
...
xin,yin
	...
	ph.dr=drhand
	ph.up=uphand
	--local t=mget(xin,yin+1)
	makethingpot(ph,
		mget(xin,yin+1)
	)
--	ph.pot=makeenttyp(t,xin,yin+1)
--	if ph.pot then
--		mset(xin,yin+1,0)
--	else
--		ph.pot={hp=1,x=xin,y=yin+1}
--	end
...
effin
	...
	--[[
	local isp=spin
	if type(spin)!="table" then
		local spin=spin or 125
		isp={spin}
	end
	--]]
	--[[
	local idx,idy=0,0
	local dirin=dirin or -1
	if dirin!=-1 then
	 idx,idy=dirts(dirin)
	end
	--]]
...

...

...

...

...

...
8080807070d300707080800000008080707000260025702500257025000000b130200000002000202000002000005050000000002000040000000000c3000020
...
80809570700070708050505050000000807070007000000070000095700016702020000000000020000055000050505020000000202000200020002000200020
...
8080257070e1708050505050008080800080707070b1702500260025000000702004000000200020202020202050202020200000200095000000950000040020
...
8080707070e1705050005000800000008000707070b1707070707070707070702020000000000000a30000955050500000202000200025002500250025002520
...
8070707070e1705000800080000080008000807080808070707070707070707020202000000000200020a35050505000d4f020002000c3950095000000950020
...
51700070f0e1e150008065800080000080008051803580800000000000000070202000000000000000a350505000c40000202041202000250025002500250020
...
0000007070707050008000800000800080008070808080707070707070700070200000002020000000a350500000002020205050502020200000040000000020
...
007000707070705050005000800000008000707070b17070707070707070007020a300202020200095505050c3f020205050a300c35050202020000020000020
...
70c300909090909000f00090909000f0e6f5000000000000000070e6f500000070e6f500000070e6f500008570e6f50000007000000000000000000070250025
...
70001570709090900000c3909090000000000000e6f5000000007000000000007000000000007000c300000070000000000070c300f5e6707000700070250000
...
7000f070707090909090909090707070707070707070707000009500007000009500007000007000007000007000007000007000000070707000700070259500
...
700000707090909090909090907070700095000000000070e6f525000070e6f52500007000009500007000007000007000007000007070700000700070262500
...
709090909090000090909090909090700025002500260070707070707070707070707070e6f52500007000000000007000c37000707070000000700000002600
...
70909090909000f090907070909090700000000000000021000000000000000000000070707070707070e6f500c30070000000007070e6f500007070b5002695
...
70909090709090909090707090909070c30000e500c3007000009500009500009500c370000070000070707070707070707070000000000000c3707025002525
...

...

...


__gff__

...

...

__sfx__
